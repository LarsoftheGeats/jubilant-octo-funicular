...
//console.log(greetUser("Jon"))//Test run: passed
...
///*Testing*/
// console.log(canWeDeliver(85205))//true
// console.log(canWeDeliver(85204))//true
// console.log(canWeDeliver(85203))//true
// console.log(canWeDeliver(85213))//true
// console.log(canWeDeliver(85206))//true
// console.log(canWeDeliver(85207))//false
///*passed*/
...
// console.log(canWeDeliverTwo(85203))//true
// console.log(canWeDeliverTwo(85213))//true
// console.log(canWeDeliverTwo(85206))//true
// console.log(canWeDeliverTwo(85207))//false
///*passed*/
...
//CODE HERE
deals[0].title=deals[0].title.replace("15%","10%")//first argument is search str, second arg is replace value
//console.log(deals)//test passed
...
//CODE HERE
//console.log(deals)//test comparing original to after modification
deals[1].desc=deals[1].desc.trim();//trim function.
deals[1].desc=deals[1].desc.replace("March","April");
//console.log(deals)//test comparing original to after mod, passed
